 ...
 */
type ServiceLogger = (message: string | object | unknown[]) => Logger;
/**
 ...
 */
declare function migrateDown(props: {
    service: AdapterService;
}): Promise<void>;
/**
 ...
 */
declare function migrateFresh(props: {
    service: AdapterService;
}): Promise<void>;
/**
 ...
 */
declare function migrateRefresh(props: {
    service: AdapterService;
}): Promise<void>;
/**
 ...
 */
declare function migrateReset(props: {
    service: AdapterService;
}): Promise<void>;
/**
 ...
 */
declare function migrateStatus(props: {
    service: AdapterService;
}): Promise<void>;
 ...
 *
 * **System Field Handling**: Automatically filters out Convex system fields (`_id`, `_creationTime`)
 * before insertion, as these are auto-generated by Convex and cannot be provided.
 *
 ...
 *
 * **System Field Handling**: Automatically filters out Convex system fields (`_id`, `_creationTime`)
 * from the compiled data before sending to Convex. These fields are auto-generated by Convex
 * and cannot be provided during insert operations.
 *
 * @template T - The type of the document data
 * @param {AdapterInsertProps<T>} props - The operation parameters
 * @param {AdapterService} props.service - The adapter service instance
 * @param {string} props.collection - The collection name
 * @param {T} props.data - The document data to insert (may contain `id` or `createdAt` which will be filtered)
 ...
 */
declare function adapterPatch<T>(props: AdapterPatchProps<T>): Promise<null>;
/**
 ...
 */
declare function adapterReplace<T>(props: AdapterReplaceProps<T>): Promise<null>;
/**
 ...
 */
type ConvexDeleteResult = ExtractConvexMutationResult<ReturnType<typeof convexDeleteOp>>;
/**
 ...
 */
declare function convexDeleteOp(props: ConvexDeleteProps): RegisteredMutation<"public", {
    id: string;
}, Promise<null>>;
/**
 ...
 */
declare function adapterDeleteOp(props: AdapterDeleteProps): Promise<null>;
/**
...
declare const deleteOp: {
    adapter: typeof adapterDeleteOp;
    convex: typeof convexDeleteOp;
};
/**
 ...
 *
 * **System Field Handling**: Automatically filters out Convex system fields (`_id`, `_creationTime`)
 * before insert or patch operations. These fields are auto-generated on insert and read-only on patch.
 *
 ...
 *
 * **System Field Handling**: Automatically filters out Convex system fields (`_id`, `_creationTime`)
 * from the compiled data before sending to Convex. These fields are auto-generated on insert
 * and read-only on patch operations.
 *
 * @template T - The type of the document data
 ...
 * @param {T} props.data - The document data (may contain `id` or `createdAt` which will be filtered)
 * @returns {Promise<ConvexUpsertResult>} The ID of the upserted document or void if patched
 */
declare function adapterUpsert<T>(props: AdapterUpsertProps<T>): Promise<string>;
/**
 ...
 * Uses the ParsedWhereFilter system for type-safe filtering.
 *
 * **Return Value**: Returns the count of deleted documents (number), not an array.
 * This ensures Convex-compatible serialization (avoids undefined values in arrays).
 *
 * @param {ConvexDeleteManyWhereProps} props - The function configuration
 * @param {AdapterService} props.service - The adapter service instance
 * @returns {RegisteredMutation} A Convex mutation function that deletes matching documents and returns the count
 */
 ...
 * @param {string} props.collection - The collection name
 * @param {ParsedWhereFilter} props.wherePlan - The parsed where filter
 * @returns {Promise<ConvexDeleteManyWhereResult>} The count of deleted documents
 */
declare function adapterDeleteManyWhere(props: AdapterDeleteManyWhereProps): Promise<number>;
/**
 ...
 */
declare function adapterIncrement(props: AdapterIncrementProps): Promise<{
    newValue: any;
} | null>;
/**
